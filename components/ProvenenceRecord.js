...
let SortData = Sharks.sort((a, b) => a.edition - b.edition);
    ...
    return (
        <div className="provenenceRecord">
         <div className="provenceGrid provenceGrid-2 py-2  mx-auto gap-5 pb-2">
         <div className="sharkID font-bold provenenceRTitles text-base opacity-80 flex items-center justify-center ">PUNKSHARK ID</div>
          <div className="font-bold provenenceRTitles text-base opacity-80 flex items-center justify-center">DNA HASH</div>
          <div className="font-bold provenenceRTitles text-base opacity-80 flex items-center justify-center">Opensea</div>
